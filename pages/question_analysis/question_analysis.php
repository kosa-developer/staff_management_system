...
<html lang="en">
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-blue">
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Question analysis</div>
                                </div>
                            </div>
                        </div>
                        <!-- start widget -->
                            ...
                            <div class="col-md-12">
                                <div class="card card-topline-green">
                                    ...
                                    <div class="card-body " id="chartjs_polar_parent">
                                        <div class="row">
                                            <canvas id="chartjs_dynamecQuestion" height="100"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            var uniquedynamicQuestionsArray=<?php echo json_encode($uniquedynamicQuestionsArray); ?>;
