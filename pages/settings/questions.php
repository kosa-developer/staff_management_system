                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <div class="actions panel_actions pull-right">
                                    <a class="btn btn-primary" href="index.php?page=<?php echo "questions". '&mode=' . $modez = ($mode == 'registered') ? 'register' : 'registered'; ?>"><i class="fa fa-eye"></i><?php echo $modez = ($mode == 'registered') ? 'Register' : 'Registered'; ?> Question(s)</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12" <?php echo $hidden; ?>>
                                ...
                                if (Input::exists() && Input::get("submit_question") == "submit_question") {
                                    ...
                                    for ($i = 0; $i < sizeof($question); $i++) {
                                        $queryDup = DB::getInstance()->checkRows("select * from survey_questions where Question='$question[$i]'");
                                        if (!$queryDup) {
                                            DB::getInstance()->insert("survey_questions", array(
                                                "Question" => $question[$i]));
                                            $submited++;
                                    ...
                                    Redirect::go_to("index.php?page=questions&mode=" . $mode);
                                }
                                ?>
                                <form role="form" action="index.php?page=<?php echo "questions" . '&mode=' . $mode; ?>"method="POST" enctype="multipart/form-data">
                            ...
                            <div  class="col-md-12" <?php echo $hidden2; ?>>
                                ...
                                if (isset($_GET['action']) && $_GET['action'] == 'delete') {
                                    ...
                                    $query = DB::getInstance()->query("UPDATE survey_questions SET Status=0 WHERE Question_Id='$quetion_id'");
                                    if ($query) {

                                        $question = DB::getInstance()->displayTableColumnValue("select Question from survey_questions where Question_Id='$quetion_id' ", "Question");
                                ...
                                if (Input::exists() && Input::get("edit_staff") == "edit_staff") {
                                    ...
                                    $question = Input::get('question');
                                    $question_z = DB::getInstance()->displayTableColumnValue("select Question from survey_questions where Question_Id='$Question_Id' ", "Question");

                                    $editquestion = DB::getInstance()->update("survey_questions", $Question_Id, array(
                                                            ...
                                                            <td style="width: 20%;">
                                                                <div class="btn-group xs">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li><a href="index.php?page=<?php echo "questions" . '&action=delete&Question_Id=' . $questionx->Question_Id . '&mode=' . $mode; ?>" onclick="return confirm('Are you sure you want to delete <?php echo $questionx->Question; ?>?');">Delete</a></li>
                                                                        <li class="divider"></li>
